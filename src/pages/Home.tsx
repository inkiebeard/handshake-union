...
const ASCII_ART =
  String.raw` __  __     ______     __   __     _____     ______     __  __     ______     __  __     ______        __  __     __   __     __     ______     __   __    
      ...
      <div className="container">
        <div className="columns is-centered">
          <div className="column is-8">
            ...
            <p>
              <span style={{ color: "var(--accent)" }}>→</span> pseudonymous — auto-assigned identity, no names
            </p>
            <p>
